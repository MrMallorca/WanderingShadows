...
Shader "DF_JP_StonesWithMoss"
{
	Properties
	{
		[HideInInspector] _AlphaCutoff("Alpha Cutoff ", Range(0, 1)) = 0.5
		[HideInInspector] _EmissionColor("Emission Color", Color) = (1,1,1,1)
		_ColorMoss("_ColorMoss", Color) = (1,1,1,0)
		_Color("_Color", Color) = (1,1,1,0)
		_MossTex("_MossTex", 2D) = "white" {}
		_MaskMap("_MaskMap", 2D) = "white" {}
		_NormalMap("_NormalMap", 2D) = "bump" {}
		_NormalIntesity("NormalIntesity", Range( 0 , 1)) = 0.56
		_FresnelScale("FresnelScale", Range( 0 , 64)) = 16.6
		_FresnelPower("FresnelPower", Range( 0 , 64)) = 16.6
		_MainTex("_MainTex", 2D) = "white" {}
		_BlurTint("BlurTint", Range( 0 , 8)) = 2
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv_MossTex = packedInput.ase_texcoord5.xy * _MossTex_ST.xy + _MossTex_ST.zw;
				float4 temp_output_16_0 = ( tex2D( _MossTex, uv_MossTex ) * _ColorMoss );
				...
				float4 blendOpSrc30 = temp_output_16_0;
				float4 blendOpDest30 = ( tex2Dlod( _MainTex, float4( uv_MainTex, 0, _BlurTint) ) * tex2DNode19.g );
				float4 lerpResult31 = lerp( ( saturate( (( blendOpDest30 > 0.5 ) ? ( 1.0 - 2.0 * ( 1.0 - blendOpDest30 ) * ( 1.0 - blendOpSrc30 ) ) : ( 2.0 * blendOpDest30 * blendOpSrc30 ) ) )) , temp_output_16_0 , _ColorMoss.a);
				float2 uv_NormalMap = packedInput.ase_texcoord5.xy * _NormalMap_ST.xy + _NormalMap_ST.zw;
				float3 tex2DNode17 = UnpackNormalmapRGorAG( tex2D( _NormalMap, uv_NormalMap ), _NormalIntesity );
				...
				float3 tanNormal24 = tex2DNode17;
				float3 worldNormal24 = float3(dot(tanToWorld0,tanNormal24), dot(tanToWorld1,tanNormal24), dot(tanToWorld2,tanNormal24));
				float fresnelNdotV20 = dot( worldNormal24, float3(0,1,0) );
				float fresnelNode20 = ( 0.0 + _FresnelScale * pow( 1.0 - fresnelNdotV20, _FresnelPower ) );
				float clampResult25 = clamp( fresnelNode20 , 0.0 , 1.0 );
				float4 lerpResult26 = lerp( lerpResult31 , ( _Color * tex2D( _MainTex, uv_MainTex ) ) , clampResult25);
				
				surfaceDescription.Albedo = lerpResult26.rgb;
				surfaceDescription.Normal = tex2DNode17;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_MossTex = packedInput.ase_texcoord.xy * _MossTex_ST.xy + _MossTex_ST.zw;
				float4 temp_output_16_0 = ( tex2D( _MossTex, uv_MossTex ) * _ColorMoss );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_MossTex = packedInput.ase_texcoord7.xy * _MossTex_ST.xy + _MossTex_ST.zw;
				float4 temp_output_16_0 = ( tex2D( _MossTex, uv_MossTex ) * _ColorMoss );
...
/*ASEBEGIN
Version=18000
393;480;1829;740;1788.999;1868.011;4.848719;True;True
Node;AmplifyShaderEditor.RangedFloatNode;18;-1268.008,-203.4371;Inherit;False;Property;_NormalIntesity;NormalIntesity;5;0;Create;True;0;0;False;0;0.56;0.52;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;29;-1473.943,-862.2831;Inherit;False;Property;_BlurTint;BlurTint;9;0;Create;True;0;0;False;0;2;0;0;8;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;27;-1717.024,-665.9976;Inherit;True;Property;_MainTex;_MainTex;8;0;Create;True;0;0;False;0;None;None;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.SamplerNode;17;-903.4056,-172.5147;Inherit;True;Property;_NormalMap;_NormalMap;4;0;Create;True;0;0;False;0;-1;276a2d6543acfd945ac1c9d2362f218a;276a2d6543acfd945ac1c9d2362f218a;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;19;-1208.504,-743.2366;Inherit;True;Property;_MaskMap;_MaskMap;3;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;14;-791.7297,-1205.723;Inherit;False;Property;_ColorMoss;_ColorMoss;0;0;Create;True;0;0;False;0;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;15;-834.519,-1408.301;Inherit;True;Property;_MossTex;_MossTex;2;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;28;-1105.613,-1838.371;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;MipLevel;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;32;-620.6637,-1657.395;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;16;-456.2302,-1309.746;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.WorldNormalVector;24;447.617,-1748.755;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.Vector3Node;21;-2.652832,-1029.715;Inherit;False;Constant;_Vector0;Vector 0;5;0;Create;True;0;0;False;0;0,1,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;23;223.0144,-965.672;Inherit;False;Property;_FresnelPower;FresnelPower;7;0;Create;True;0;0;False;0;16.6;0;0;64;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;22;153.0144,-1263.672;Inherit;False;Property;_FresnelScale;FresnelScale;6;0;Create;True;0;0;False;0;16.6;0;0;64;0;1;FLOAT;0
Node;AmplifyShaderEditor.BlendOpsNode;30;-177.8295,-1665.929;Inherit;False;Overlay;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;11;-872.2018,-917.4796;Inherit;False;Property;_Color;_Color;1;0;Create;True;0;0;False;0;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FresnelNode;20;667.6463,-1112.515;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;40.5;False;3;FLOAT;4.98;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;12;-1075.687,-458.5009;Inherit;True;Property;_MainTex2;_MainTex2;0;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ClampOpNode;25;1170.235,-1190.034;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-463,-630.5;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;31;-138.5461,-1362.741;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;26;1717.676,-1265.41;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.OneMinusNode;33;1135.415,-920.3602;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
WireConnection;0;7;19;4
WireConnection;0;8;19;2
ASEEND*/
//CHKSM=776200FCDD9622FEB29E4506340F2ABB3C548FAC